...
- `ntpwedit64.exe`, `ntpwedit.exe`, and `ntpweditarm64.exe` ג€” graphical interface.
- `ntpwcli.exe` ג€” native console application for inventory, status, JSON output, backup, restore, password change, unlock, enable, and disable operations.
